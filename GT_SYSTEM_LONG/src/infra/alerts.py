...
class AlertManager:
    ...
    ALERT_CODES = {
        ...
        "NAKED_POSITION": "Position open at broker but no protective SELL stop-limit",
        "STOP_LOSS_MARKET_FALLBACK": "Gap-down at protective-stop placement: submitted MARKET SELL because LTP had already crossed below intended stop",
        "ENTRY_ORDER_MISSING": "Engine state MONITORING/WAITING_REENTRY but no BUY order resting",
